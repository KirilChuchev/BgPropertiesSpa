    ...
    public static class HelpMethods
    {
        ...
        public static IEnumerable<SearchCriteriaViewModel> GetFullfilledSearchCriterias(BaseInputViewModel instance)
        {
            var searchCriterias = new HashSet<SearchCriteriaViewModel>()
            {
                ...
                new SearchCriteriaViewModel() { Name = "priceFrom", Value = (instance.PriceFrom?.Trim() == "") ? null : instance.PriceFrom },
                new SearchCriteriaViewModel() { Name = "priceTo", Value = (instance.PriceTo?.Trim() == "") ? null : instance.PriceTo },
                new SearchCriteriaViewModel() { Name = "pricePerSqrMFrom", Value = (instance.PricePerSqrMFrom?.Trim() == "") ? null : instance.PricePerSqrMFrom },
                new SearchCriteriaViewModel() { Name = "pricePerSqrMTo", Value = (instance.PricePerSqrMTo?.Trim() == "") ? null : instance.PricePerSqrMTo },
                new SearchCriteriaViewModel() { Name = "sizeFrom", Value = (instance.SizeFrom?.Trim() == "") ? null : instance.SizeFrom },
                new SearchCriteriaViewModel() { Name = "sizeTo", Value = (instance.SizeTo?.Trim() == "") ? null : instance.SizeTo },
                new SearchCriteriaViewModel() { Name = "floorFrom", Value = (instance.FloorFrom?.Trim() == "") ? null : instance.FloorFrom },
                new SearchCriteriaViewModel() { Name = "floorTo", Value = (instance.FloorTo?.Trim() == "") ? null : instance.FloorTo },
