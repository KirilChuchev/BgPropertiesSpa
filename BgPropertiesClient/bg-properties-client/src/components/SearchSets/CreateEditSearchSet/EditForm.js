                  ...
                  <div>
                    <label>
                      <input
                        ...
                        id="vi1"
                        checked={searchSet.oneRoomPropType}
                        onChange={handleChange}
                      />
                      1-СТАЕН
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        checked={searchSet.twoRoomsPropType}
                        onChange={handleChange}
                      />
                      2-СТАЕН
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        id="vi3"
                        checked={searchSet.threeRoomsPropType}
                        onChange={handleChange}
                      />
                      3-СТАЕН
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        id="vi4"
                        checked={searchSet.fourRoomsPropType}
                        onChange={handleChange}
                      />
                      4-СТАЕН
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        id="vi5"
                        checked={searchSet.multiRoomsPropType}
                        onChange={handleChange}
                      />
                      МНОГОСТАЕН
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        id="vi6"
                        checked={searchSet.maisonettePropType}
                        onChange={handleChange}
                      />
                      МЕЗОНЕТ
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        name="studioPropType"
                        id="vi8"
                        checked={searchSet.studioPropType}
                        onChange={handleChange}
                      />
                      АТЕЛИЕ, ТАВАН
                    </label>
              ...
              <td width="154" valign="top">
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        name="officePropType"
                        id="vi7"
                        checked={searchSet.officePropType}
                        onChange={handleChange}
                      />
                      ОФИС
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        name="storePropType"
                        id="vi12"
                        checked={searchSet.storePropType}
                        onChange={handleChange}
                      />
                      МАГАЗИН
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        id="vi13"
                        checked={searchSet.restaurantPropType}
                        onChange={handleChange}
                      />
                      ЗАВЕДЕНИЕ
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        id="vi14"
                        checked={searchSet.warehousePropType}
                        onChange={handleChange}
                      />
                      СКЛАД
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        name="hotelPropType"
                        id="vi17"
                        checked={searchSet.hotelPropType}
                        onChange={handleChange}
                      />
                      ХОТЕЛ
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        id="vi16"
                        checked={searchSet.industrialPropType}
                        onChange={handleChange}
                      />
                      ПРОМ. ПОМЕЩЕНИЕ
                    </label>
                ...
                >
                  <label>
                    ...
                    id="vi20" 
                    checked={searchSet.businessPropType}
                    onChange={handleChange}
                    />
                    БИЗНЕС ИМОТ
                  </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        id="vi9"
                        checked={searchSet.houseFloorPropType}
                        onChange={handleChange}
                      />
                      ЕТАЖ ОТ КЪЩА
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        name="housePropType"
                        id="vi10"
                        checked={searchSet.housePropType}
                        onChange={handleChange}
                      />
                      КЪЩА
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        id="vi11"
                        checked={searchSet.villagePropType}
                        onChange={handleChange}
                      />
                      ВИЛА
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        name="plotPropType"
                        id="vi18"
                        checked={searchSet.plotPropType}
                        onChange={handleChange}
                      />
                      ПАРЦЕЛ
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        name="garagePropType"
                        id="vi15"
                        checked={searchSet.garagePropType}
                        onChange={handleChange}
                      />
                      ГАРАЖ
                    </label>
                  ...
                  <div>
                    <label>
                      <input
                        ...
                        name="landPropType"
                        id="vi19"
                        checked={searchSet.landPropType}
                        onChange={handleChange}
                      />
                      ЗЕМЕДЕЛСКА ЗЕМЯ
                    </label>
          ...
          <tbody>
            ...
            <tr>
              ...
              >
                <input
                  type="submit"
                  value="З А П И Ш И  П Р О М Е Н И Т Е"
