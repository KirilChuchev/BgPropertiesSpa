...
class SearchSetCreate extends Component {
  constructor(props) {
    super(props);
    this.state = {
      searchSetName: "",
  ...
  handleChange(event) {
    ...
    // this.setState((oldState) => ({ ...oldState,...obj }));
    this.setState({ ...this.state, ...obj });
    console.log(this.state);
  }

  handleSubmit(event) {
    alert("Вашият нов SearchSet бе успешно създаден.");
    event.preventDefault();
    console.log(this.state);
    // console.log(JSON.stringify(this.state));
    searchSetService.create({ ...this.state });
  }
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          id="vi1"
                          value={this.state.oneRoomPropType}
                          onChange={this.handleChange}
                        />
                        1-СТАЕН
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          id="vi2"
                          value={this.state.twoRoomsPropType}
                          onChange={this.handleChange}
                        />
                        2-СТАЕН
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          id="vi3"
                          value={this.state.threeRoomsPropType}
                          onChange={this.handleChange}
                        />
                        3-СТАЕН
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          id="vi4"
                          value={this.state.fourRoomsPropType}
                          onChange={this.handleChange}
                        />
                        4-СТАЕН
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          id="vi5"
                          value={this.state.multiRoomsPropType}
                          onChange={this.handleChange}
                        />
                        МНОГОСТАЕН
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          id="vi6"
                          value={this.state.maisonettePropType}
                          onChange={this.handleChange}
                        />
                        МЕЗОНЕТ
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          name="studioPropType"
                          id="vi8"
                          value={this.state.studioPropType}
                          onChange={this.handleChange}
                        />
                        АТЕЛИЕ, ТАВАН
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          name="officePropType"
                          id="vi7"
                          value={this.state.officePropType}
                          onChange={this.handleChange}
                        />
                        ОФИС
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          name="storePropType"
                          id="vi12"
                          value={this.state.storePropType}
                          onChange={this.handleChange}
                        />
                        МАГАЗИН
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          id="vi13"
                          value={this.state.restaurantPropType}
                          onChange={this.handleChange}
                        />
                        ЗАВЕДЕНИЕ
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          name="hotelPropType"
                          id="vi17"
                          value={this.state.hotelPropType}
                          onChange={this.handleChange}
                        />
                        ХОТЕЛ
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          name="housePropType"
                          id="vi10"
                          value={this.state.housePropType}
                          onChange={this.handleChange}
                        />
                        КЪЩА
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          id="vi11"
                          value={this.state.villagePropType}
                          onChange={this.handleChange}
                        />
                        ВИЛА
                      </label>
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          name="garagePropType"
                          id="vi15"
                          value={this.state.garagePropType}
                          onChange={this.handleChange}
                        />
                        ГАРАЖ
                      </label>
              ...
              <tr>
                ...
                >
                  ...
                  <input
                    ...
                    size="4"
                    maxLength="8"
                    value={this.state.pricePerSqrMFrom}
                    onChange={this.handleChange}
                  />
                </td>
                <td width="5">
                ...
                >
                  ...
                  <input
                    ...
                    size="4"
                    maxLength="8"
                    value={this.state.pricePerSqrMTo}
                    onChange={this.handleChange}
                  />
                </td>
                <td width="5">
              ...
              <tr>
                ...
                >
                  ...
                  >
                    ...
                    <option value="област Благоевград">
                      област Благоевград
                    </option>
